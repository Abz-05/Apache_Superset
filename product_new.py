...
class ProductGenerator:
    ...
    def _get_brand_abbreviation(brand: str) -> str:
        ...
        abbr_map = {
            'NestlÃ©': 'NEST', 'Unilever': 'UNIL', 'ITC': 'ITC',
    ...
    def generate_food_beverages_products(self, target_pskus: int = 2100) -> None:
        ...
        # NestlÃ© products
        self._generate_coffee_products('NestlÃ©', 'Nescafe', target_pskus=80)
        self._generate_noodles_products('NestlÃ©', 'Maggi', target_pskus=60)
        self._generate_chocolate_products('NestlÃ©', 'KitKat', target_pskus=40)
        self._generate_dairy_products('NestlÃ©', 'a+', target_pskus=50)
    ...
    def _generate_misc_food_products(self, target_pskus: int) -> None:
        ...
        brands_subcats = [
            ('NestlÃ©', 'Cerelac', 'Baby Cereals'),
            ('NestlÃ©', 'Milo', 'Health Drinks'),
    ...
    def generate_home_care_products(self, target_pskus: int = 700) -> None:
        ...
        # ITC products
        self._generate_home_care_misc('ITC', 'Savlon', target_pskus=30)
    ...
    def validate_brand_category_mappings(self) -> bool:
        ...
        logger.info("âœ“ All brand-category mappings valid")
        return True
    ...
    def save_to_database(self, db_config: Dict) -> None:
        ...
        logger.info("âœ“ Products saved to database")
...
def main():
    ...
    logger.info("âœ“ Product generation complete!")
